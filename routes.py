...
def upload_file():
    try:
        ...
        file_extension = original_filename.rsplit('.', 1)[1].lower() if '.' in original_filename else 'No extension'
        print(f"📄 Original file name: {original_filename}, Extension: {file_extension}")
